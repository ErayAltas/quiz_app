...
import 'package:quiz_app/data/repositories/result_repo.dart';
...
class ResultDetailScreen extends StatelessWidget {
  ...
  ResultDetailScreen({super.key, required this.score, required this.categoryIndex, required this.attempts, required this.wrongAttempts, required this.correctAttempts, required this.difficultyLevel, required this.isSaved}) {
    if (isSaved == false) {
      resultRepo.saveScore(score, difficultyLevel, attempts, wrongAttempts, correctAttempts, categoryDetailList[categoryIndex].title, categoryIndex);
    }
  }

...
class _ResultsState extends State<Results> {
    ...
    return DropdownButtonFormField2(
      ...
      onChanged: (value) {
        ...
        if (selectedCategoryValue != '') {
          BlocProvider.of<ResultsBloc>(context).add(CategoryDataRequested(selectedCategoryValue, selectedDifficultyLevelValue));
        }
      },
      onSaved: (value) {
  ...
  DropdownButtonFormField2<String> buildDropdownCategory(Success state, BuildContext context) {
    return DropdownButtonFormField2(
      decoration: InputDecoration(
        isDense: true,
        contentPadding: EdgeInsets.zero,
  ...
  DropdownButtonFormField2<String> buildDropdownDifficultyLevelEmpty(Success state, BuildContext context) {
    return DropdownButtonFormField2(
      decoration: InputDecoration(
        isDense: true,
        contentPadding: EdgeInsets.zero,
  ...
  DropdownButtonFormField2<String> buildDropdownCategoryEmpty(Success state, BuildContext context) {
    return DropdownButtonFormField2(
      decoration: InputDecoration(
        isDense: true,
        contentPadding: EdgeInsets.zero,
